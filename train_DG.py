...
def get_args():
    ...
    parser.add_argument("--is_DA", type=bool, default=False, help="Do not change this field, is only a flag needed in the code")
...
class Trainer:
    def __init__(self, args, device):
        ...
        if args.is_AdaIN == True:
          AdaIN_model = Model()
          AdaIN_model.load_state_dict(torch.load("/content/drive/MyDrive/MLAI_Project/Adain_models/ADAIN_MODEL_" + args.target + ".pth"))
    ...
    def _do_epoch(self):
        ...
        for it, ((data, jigsaw_l, class_l),_) in enumerate(self.source_loader):
            ...
            loss = class_loss + self.alpha_parameter * jigsaw_loss
